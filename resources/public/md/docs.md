...
Two middleware functions are provided by default in the `fun-test.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `fun-test.handler` namespace to manage the enabled middleware.
